extends Node2D
@onready var timer: RichTextLabel = $"Themed Timer" #literally just the richlabeltext
...
func timer_start(start_time: float): # making a new function for timer countdown!
